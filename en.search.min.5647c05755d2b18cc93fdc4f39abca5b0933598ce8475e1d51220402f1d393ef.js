'use strict';(function(){const searchDataURL='/en.search-data.min.f2d64ab7c841a0632ec752bb3d3af0534d588ef9f614b0e039b1bd83a11beb6a.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
